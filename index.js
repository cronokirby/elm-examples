...
(function(exports) {
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Increment.create)) ])([ Halogen_HTML_Core.text("+") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Decrement.create)) ])([ Halogen_HTML_Core.text("-") ]) ]);
  };
  var $$eval = function (v) {
      if (v instanceof Increment) {
          return Data_Functor.voidLeft(Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Semiring.add(Data_Semiring.semiringInt)(1)))(v.value0);
      };
      if (v instanceof Decrement) {
          return Data_Functor.voidLeft(Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Function.flip(Data_Ring.sub(Data_Ring.ringInt))(1)))(v.value0);
      };
      throw new Error("Failed pattern match at SimpleCounter line 35, column 8 - line 39, column 32: " + [ v.constructor.name ]);
  };
  var button = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
...
})(PS["SimpleCounter"] = PS["SimpleCounter"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Bind = PS["Control.Bind"];
  ...
  var Prelude = PS["Prelude"];
  var SimpleCounter = PS["SimpleCounter"];        
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(SimpleCounter.button)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
